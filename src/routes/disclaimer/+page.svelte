  <svelte:head>
      <title>Disclaimer - Psychology4.me</title>
   </svelte:head>
  <section class="padding-top-10">
      <div class="content">
          <div class="container-l"> 
            <div class="container-m"> 
            <h1 class="heading-5 padding-top-10">Disclaimer</h1>
