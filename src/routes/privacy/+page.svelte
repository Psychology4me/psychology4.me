<svelte:head>
	<title>Privacy Policy - Psychology4.me</title>
	<meta
		data-key="description"
		name="description"
		content="As a psychologist I am legally bound to confidentiality. This is in regard to all matters confided to me during the course of my counselling. Email addresses, contact information, names, personal or medical data will not be disclosed without the explicit consent of the person concerned (except when legally required)."
	/>
</svelte:head>
	...
	<div class="content">
		<div class="container-l">
			<div class="container-m">
				<h1 class="heading-5 padding-top-10">Privacy Policy</h1>
				<p>
					As a psychologist I am legally bound to confidentiality. This is in regard to all matters
				...
				<p>
					My work is based on professional ethical guidelines as they apply generally to
				...
				<p>
					Please bare in mind that the transmission of data over the Internet, including email
				...
				<p class="padding-0 margin-0">
					T: <b>+49 175 70 454 86</b>
				</p>
				<p class="padding-0 margin-0">
					E: <b
						><a href="mailto:p.pfoertner@psychology4.me" class="link-underlined "
							>p. pfoertner@psychology4.me</a
						></b
					>
				</p>
				<p>
				...
				<p>
					<b
						...
						click here to go directly to our table of contents.</b
					>
				</p>
				<p>
				...
				<p>
					<b>Do we process any sensitive personal information?</b> We may process sensitive personal
				...
				<p>
					<b>In what situations and with which parties do we share personal information?</b> We may share
					information in specific situations and with specific third parties. Scroll down to learn more.
				</p>
				<p>
					<b>How do we keep your information safe?</b> We have organisational and technical processes
				...
				<p>
					...
					<a
						href="https://app.termly.io/notify/0250d804-c37f-43a2-89f5-1260643ae2a6"
						class="link-underlined">here</a
				...
				<ul style="font-size: 20px; font-weight: bold">
					<li>Inventory data (e.g., names, addresse, billing addresses, mailing addressess)</li>
				...
				<p>
					However, we use <a href="https://plausible.io" target="_blank" rel="noreferrer"
						>Plausible</a
					>, which is intuitive, lightweight and open source web analytics. No cookies and fully
					compliant with GDPR, CCPA and PECR.
				</p>
				<p>
					<b>Sensitive Information.</b> When necessary, with your consent or as otherwise permitted by
				...
				<p>
					<b
						...
						interact with our Services, including:</b
					>
				</p>
				<p>
					1. To deliver and facilitate delivery of services to the user. We may process your
				...
				<p>
					<b>1. Content.</b> We may process your information if you have given us permission (i.e.
				...
				<p>
					<b>In Short:</b> We are not responsible for the safety of any information that you share with
				...
				<p>
					<b>In Short:</b> We keep your information for as long as necessary to fulfil the purposes outlined
				...
				<p>
					<b>In Short:</b> We aim to protect your personal information through a system of organisational
				...
				<p>
					<b>In Short:</b> In some regions, such as the European Economic Area (EEA), United Kingdom
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>
								<p>
									Contents of email or text messages, debit or credit card numbers and health data
				...
				<p>
					- Category L: As long as the user has an account with us, however your data is anonymised
					on the platform
				</p>
				<p>
				...
				<p>
					Patric Pförtner has not disclosed, sold, or shared any personal information to third
				...
				<p>
					...
					please email privacy@psychology4.me or submit a request form by clicking <a
						href="https://app.termly.io/notify/0250d804-c37f-43a2-89f5-1260643ae2a6"
						target="_blank"
						rel="noreferrer"
						class="link-underlined">here</a
				...
				<p>
					To exercise these rights, you can contact us by email at privacy@psychology4.me, or by
...
<p>The information we collect, use, and disclose about you will vary depending on how you interact with Patric Pf&ouml;rtner and our Services. To find out more, please visit the following links:</p>
...
<p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) , Patric Pf&ouml;rtner, by email at p.pfoertner@psychology4.me, or by post to:</p>
...
<p>Our website uses Plausible Analytics to help us understand visitor trends and the effectiveness of our marketing outreach. We chose Plausible Analytics because it is a privacy-focused company and platform that eschews personally identifiable information in favor of anonymous aggregate data. See the Plausible Analytics
  <a href="https://plausible.io/data-policy" target="_blank" class="link-underlined" rel="noreferrer">Data Policy.</a>
</p>
<p>
  ...
  <p>
  For security reasons (e.g. to clarify misuse or fraud), log file information is stored for a maximum of 7 days and then deleted. Data whose further storage is required for evidence purposes are excluded from deletion until the respective incident has been finally clarified.</p>
</div>
		</div>
	</div>
</section>
