...
const Benefits_of_online_counselling = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<p>At its core, the Repeat sensibility is friendly, bright, and optimistic — like how each of us might describe our favorite CPG products. We imaged Repeat as a brand that makes products people love, added a tech layer, and gave it a smart and spontaneous persona, with moments of playful interaction and nods to things that only CPG insiders would understand. The result is a joyful and light experience, and a friendly reminder that if you take care of your customers, they might just return the favor. </p>`;
});
export {
  Benefits_of_online_counselling as default,
  metadata
};
