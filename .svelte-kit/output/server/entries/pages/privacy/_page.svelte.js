...
<section class="${"padding-top-10"}"><div class="${"content"}"><div class="${"container-l"}"><div class="${"container-m"}"><h1 class="${"heading-5 padding-top-10"}">Privacy Policy</h1>
				<p>As a psychologist I am legally bound to confidentiality. This is in regard to all matters
					confided to me during the course of my counselling. Email addresses, contact information,
					names, personal or medical data will not be disclosed without the explicit consent of the
					person concerned (except when legally required).
				</p>
				<p>My work is based on professional ethical guidelines as they apply generally to
					psychologists. The counselling services offered here are performed in the function of a
					psychologist. These are NOT psychotherapeutic services.
				</p>
				<p>Please bare in mind that the transmission of data over the Internet, including email
					communication, can have security gaps and their contents could possibly be viewed by third
					parties. Proceed carefully when writing emails and possibly omit the disclosure of
					specific information, such as names, medical information and addresses.
				</p>
				<p><b>Last Updated 20. February 2023</b></p>
				<h2>Responsible (Information according to German § 5 TMG)</h2>
				<p>Patric Pförtner (M. Sc. Psychologist) <br>Ivan Pamukchiev 7A <br>5600 Troyan</p>
				<h2>Contact</h2>
				<p class="${"padding-0 margin-0"}">T: <b>+49 175 70 454 86</b></p>
				<p class="${"padding-0 margin-0"}">E: <b><a href="${"mailto:p.pfoertner@psychology4.me"}" class="${"link-underlined "}">p. pfoertner@psychology4.me</a></b></p>
				<p><b>Questions or concerns?</b> Reading this privacy notice will help you understand your privacy
					rights and choices. If you do not agree with our policies and practices, please do not use
					our Services. If you still have any questions or concerns, please contact us at p.pfoertner@psychology4.me.
				</p>
				<h2>SUMMARY OF KEY POINTS</h2>
				<p><b>This summary provides key points from our privacy notice, but you can find out more
						...
						click here to go directly to our table of contents.</b></p>
				<p><b>What personal information do we process?</b> When you visit, use, or navigate our Services,
					we may process personal information depending on how you interact with Patric Pförtner and
					the Services, the choices you make, and the products and features you use. Scroll down to learn
					more.
				</p>
				<p><b>Do we process any sensitive personal information?</b> We may process sensitive personal
					information when necessary with your consent or as otherwise permitted by applicable law. Scroll
					down to learn more.
				</p>
				<p><b>Do we receive any information from third parties?</b> We do not receive any information
					from third parties.
				</p>
				<p><b>How do we process your information?</b> We process your information to provide, improve,
					...
					We process your information only when we have a valid legal reason to do so. Scroll down to
					learn more.
				</p>
				<p><b>In what situations and with which parties do we share personal information?</b> We may share
					information in specific situations and with specific third parties. Scroll down to learn more.
				</p>
				<p><b>How do we keep your information safe?</b> We have organisational and technical processes
					...
					we cannot promise or guarantee that hackers, cybercriminals, or other unauthorised third parties
					will not be able to defeat our security and improperly collect, access, steal, or modify your
					information. Scroll down to learn more
				</p>
				<p><b>What are your rights?</b> Depending on where you are located geographically, the applicable
					privacy law may mean you have certain rights regarding your personal information. Scroll down
					to learn more
				</p>
				<p><b>How do you exercise your rights?</b> The easiest way to exercise your rights is by
					filling out our data subject request form available
					<a href="${"https://app.termly.io/notify/0250d804-c37f-43a2-89f5-1260643ae2a6"}" class="${"link-underlined"}">here</a>, or by contacting us. We will consider and act upon any request in accordance with
				...
				<p><b>Personal Information Provided by You.</b> The personal information that we collect depends
				...
				<ul style="${"font-size: 20px; font-weight: bold"}"><li>Inventory data (e.g., names, addresse, billing addresses, mailing addressess)</li>
					<li>Content data (e.g., text entries, photographs, videos)</li>
					<li>Usage data (e.g., web pages visited, interest in content, access times)</li></ul>
				<p>However, we use <a href="${"https://plausible.io"}" target="${"_blank"}" rel="${"noreferrer"}">Plausible</a>, which is intuitive, lightweight and open source web analytics. No cookies and fully
					compliant with GDPR, CCPA and PECR.
				</p>
				<p><b>Sensitive Information.</b> When necessary, with your consent or as otherwise permitted by
					applicable law, we process the following categories of sensitive information.
				</p>
				<ul style="${"font-size: 20px; font-weight: bold"}"><li>health data</li>
					<li>mental health data</li></ul>
				<p><b>Payment Data.</b> We may collect data necessary to process your payment if you make purchases,
					such as your payment instrument number, and the security code associated with your payment
					instrument. All payment data is stored by Mollie. You may find their privacy notice link(s)
					here. https://www.mollie.com/privacy.
				</p>
				<p>All personal information that you provide to us must be true, complete, and accurate, and
				...
				<p>1. To deliver and facilitate delivery of services to the user. We may process your
					information to provide you with the requested service. <br>
					2. To respond to user inquiries/offer support to users. We may process your information to
					respond to your inquiries and solve any potential issues you might have with the requested
					service.<br>
					3. To send administrative information to you. We may process your information to send you details
					about our products and services, changes to our terms and policies, and other similar information.<br>
					4. To fulfil and manage your orders. We may process your information to fulfil and manage your
					orders, payments, returns, and exchanges made through the Services.<br>
					5. To enable user-to-user communications. We may process your information if you choose to
					use any of our offerings that allow for communication with another user.<br>
					6. To request feedback. We may process your information when necessary to request feedback
					and to contact you about your use of our Services.<br>
					7. To send you marketing and promotional communications. We may process the personal information
					you send to us for our marketing purposes, if this is in accordance with your marketing preferences.
					You can opt out of our marketing emails at any time. For more information, see &#39;WHAT ARE YOUR
					PRIVACY RIGHTS?&#39; below).<br>
					8. To protect our Services. We may process your information as part of our efforts to keep
					our Services safe and secure, including fraud monitoring and prevention.<br>
					9. To save or protect an individual&#39;s vital interest. We may process your information when
					necessary to save or protect an individual’s vital interest, such as to prevent harm.<br>
					10. Tracking Mental Health Data. In oder to perform my counselling I need to collect data from
					my clients regarding their state of mind. This is to ensure that the counselling is efficient.
				</p>
				<h2>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
				<p><b>In Short:</b> We only process your personal information when we believe it is necessary
					and we have a valid legal reason (i.e. legal basis) to do so under applicable law, like with
					your consent, to comply with laws, to provide you with services to enter into or fulfil our
				...
				<p><b>1. Content.</b> We may process your information if you have given us permission (i.e.
					consent) to use your personal information for a specific purpose. You can withdraw your
					consent at any time. Click here to learn more.<br>
					<b>2. Performance of a Contract.</b> We may process your personal information when we
					believe it is necessary to fulfil our contractual obligations to you, including providing
					our Services or at your request prior to entering into a contract with you.<br>
					<b>3. Legitimate Interests.</b> We may process your information when we believe it is
					...
					process your personal information for some of the purposes described in order to:<br>
					4. Send users information about special offers and discounts on our products and services<br>
					5. Diagnose problems and/or prevent fraudulent activities<br>
					6. Understand how our users use our products and services so we can improve user experience<br>
					<b>7. Legal Obligations.</b> We may process your information where we believe it is
					...
					your information as evidence in litigation in which we are involved.<br>
					<b>8. Vital Interests.</b> We may process your information where we believe it is necessary
				...
				<ul style="${"font-size: 20px; font-weight: 500"}"><li>If collection is clearly in the interests of an individual and consent cannot be
					...
					<li>If the information is publicly available and is specified by the regulations</li></ul>
				<h2>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
				<p><b>In Short:</b> We may share information in specific situations described in this section
					and/or with the following third parties.
				</p>
				<p>We may need to share your personal information in the following situations:</p>
				<p><b>Business Transfers.</b> We may share or transfer your information in connection with, or
				...
				<p><b>In Short:</b> We are not responsible for the safety of any information that you share with
				...
				<p>The Services may link to third-party websites, online services, or mobile applications
					...
					notice. We are not responsible for the content or privacy and security practices and
					policies of any third parties, including other websites, services, or applications that
					may be linked to or from the Services. You should review the policies of such third
					parties and contact them directly to respond to your questions.
				</p>
				<h2>6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
				<p><b>In Short:</b> We keep your information for as long as necessary to fulfil the purposes outlined
				...
				<p>We will only keep your personal information for as long as it is necessary for the
					...
					this notice will require us keeping your personal information for longer than 1 year after
					finishing your last consult. if there is no more payment due, then you can request to have
					your data deleted earlier.
				</p>
				...
				<p><b>In Short:</b> We aim to protect your personal information through a system of organisational
					and technical security measures.
				</p>
				<p>We have implemented appropriate and reasonable technical and organisational security
				...
				<p><b>In Short:</b> We do not knowingly collect data from or market to children under 18 years
					of age.
				</p>
				<p>We do not knowingly solicit data from or market to children under 18 years of age. By
					...
					under age 18, please contact us at p.pfoertner@psychology4.me.
				</p>
				<h2>9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
				<p><b>In Short:</b> In some regions, such as the European Economic Area (EEA), United Kingdom
				...
				<p>In some regions (like the EEA, UK, and Canada), you have certain rights under applicable
				...
				<p>We will consider and act upon any request in accordance with applicable data protection
					laws.
				</p>
				<p>If you are located in the EEA or UK and you believe we are unlawfully processing your
					...
					located in Switzerland, the contact details for the data protection authorities are
					available here: https://www.edoeb.admin.ch/edoeb/en/home.html. Withdrawing your consent:
				...
				<p><b>Opting out of marketing and promotional communications:</b> You can unsubscribe from our
					...
					CAN YOU CONTACT US ABOUT THIS NOTICE?&#39; below. You will then be removed from the marketing lists.
					However, we may still communicate with you — for example, to send you service-related messages
					that are necessary for the administration and use of your account, to respond to service requests,
					or for other non-marketing purposes.
				</p>
				<p>If you have questions or comments about your privacy rights, you may email us at
					privacy@psychology4.me.
				</p>
				...
				<p><b>In Short:</b> Yes, if you are a resident of California, you are granted specific rights
				...
				<p>(1) every individual who is in the State of California for other than a temporary or
					transitory purpose and (2) every individual who is domiciled in the State of California
					who is outside the State of California for a temporary or transitory purpose. All other
					individuals are defined as &#39;non-residents&#39;.<br>
				...
				<table><tbody><tr><td><p>Category</p></td>
							<td><p>Examples</p></td>
							<td><p>Collected</p></td></tr>
						<tr><td><p>A. Identifiers</p></td>
							<td><p>Contact details, such as real name, alias, postal address, telephone or mobile
									contact number, unique personal identifier, online identifier, Internet Protocol
									address, email address, and account name
								</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>B. Personal information categories listed in the California Customer Records
									statute
								</p></td>
							<td><p>Name, contact information, education, employment, employment history, and
									financial information
								</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>C. Protected classification characteristics under California or federal law</p></td>
							<td><p>Gender and date of birth</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>D. Commercial information</p></td>
							<td><p>Transaction information, purchase history, financial details, and payment
									information
								</p></td>
							<td><p>Yes</p></td></tr>
						<tr><td><p>E. Biometric information</p></td>
							<td><p>Fingerprints and voiceprints</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>F. Internet or other similar network activity</p></td>
							<td><p>Browsing history, search history, online behaviour, interest data, and
									interactions with our and other websites, applications, systems, and
									advertisements
								</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>G. Geolocation data</p></td>
							<td><p>Device location</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>H. Audio, electronic, visual, thermal, olfactory, or similar information</p></td>
							<td><p>Images and audio, video or call recordings created in connection with our business
									activities
								</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>I. Professional or employment-related information</p></td>
							<td><p>Business contact details in order to provide you our Services at a business level
									or job title, work history, and professional qualifications if you apply for a job
									with us
								</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>J. Education Information</p></td>
							<td><p>Student records and directory information</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>K. Inferences drawn from other personal information</p></td>
							<td><p>Inferences drawn from any of the collected personal information listed above to
									create a profile or summary about, for example, an individual’s preferences and
									characteristics
								</p></td>
							<td><p>NO</p></td></tr>
						<tr><td><p>L. Sensitive Personal Information</p></td>
							<td><p>Contents of email or text messages, debit or credit card numbers and health data
									as well as mental health data
								</p></td>
							<td><p>Yes</p></td></tr></tbody></table>
				<p>We will use and retain the collected personal information as needed to provide the
					Services or for:
				</p>
				<p>- Category L: As long as the user has an account with us, however your data is anonymised
					on the platform
				</p>
				...
				<p>- Receiving help through our customer support channels;<br>
				...
				<p>More information about our data collection and sharing practices can be found in this
					privacy notice. You may contact us by email at privacy@psychology4.me, or by referring to
					the contact details at the bottom of this document. If you are using an authorised agent
					to exercise your right to opt out we may deny a request if the authorised agent does not
				...
				<p>We may disclose your personal information with our service providers pursuant to a written
					...
					entity that processes the information on our behalf, following the same strict privacy
				...
				<p>Patric Pförtner has not disclosed, sold, or shared any personal information to third
					parties for a business or commercial purpose in the preceding twelve (12) months. Patric
					Pförtner will not sell or share personal information in the future belonging to website
				...
				<p>- whether we collect and use your personal information;<br>
				...
				<p>- social security information, drivers&#39; licenses, state ID cards, passport numbers<br>
				...
				<p>Once a business receives your request, they are no longer allowed to use or disclose your
					sensitive personal information for any other purpose unless you provide consent for the
					use or disclosure of sensitive personal information for additional purposes.
				</p>

				<p>Please note that sensitive personal information that is collected or processed without the
					purpose of inferring characteristics about a consumer is not covered by this right, as
					well as the publicly available information.
				</p>
				<p>To exercise your right to limit use and disclosure of sensitive personal information,
					please email privacy@psychology4.me or submit a request form by clicking <a href="${"https://app.termly.io/notify/0250d804-c37f-43a2-89f5-1260643ae2a6"}" target="${"_blank"}" rel="${"noreferrer"}" class="${"link-underlined"}">here</a></p>
				...
				<p>You may request correction of your personal data if it is incorrect or no longer relevant,
					or ask to restrict the processing of the information.
				</p>
				<p>You can designate an authorised agent to make a request under the CCPA on your behalf. We
				...
				<p>You may request to opt out from future selling or sharing of your personal information to
				...
				<p>To exercise these rights, you can contact us by email at privacy@psychology4.me, or by
...
<p><b>In Short:</b> Yes, if you are a resident of Virginia, you may be granted specific rights regarding access to and use of your personal information.</p>
...
<p>The information we collect, use, and disclose about you will vary depending on how you interact with Patric Pförtner and our Services. To find out more, please visit the following links:</p>

<p>Personal data we collect How we use your personal data When and with whom we share your personal data Your rights with respect to your personal data</p>

<p>Right to be informed whether or not we are processing your personal data Right to access your personal data Right to correct inaccuracies in your personal data Right to request deletion of your personal data Right to obtain a copy of the personal data you previously shared with us Right to opt out of the processing of your personal data if it is used for targeted advertising, the sale of personal data, or profiling in furtherance of decisions that produce legal or similarly significant effects (&#39;profiling&#39;) Patric Pförtner has not sold any personal data to third parties for business or commercial purposes. Patric Pförtner will not sell personal data in the future belonging to website visitors, users, and other consumers.</p>
...
<p>You may contact us by email at privacy@psychology4.me, by visiting our <a href="${"https://app.termly.io/notify/0250d804-c37f-43a2-89f5-1260643ae2a6"}" target="${"_blank"}" rel="${"noreferrer"}" class="${"link-underlined"}">data subject request form</a>, or by referring to the contact details at the bottom of this document. If you are using an authorised agent to exercise your rights, we may deny a request if the authorised agent does not submit proof that they have been validly authorised to act on your behalf.</p>
...
<p>If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it. If you wish to appeal our decision, please email us at privacy@psychology4.me. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal if denied, you may contact the Attorney General to 
  <a href="${"https://www.oag.state.va.us/consumer-protection/index.php/file-a-complaint"}" target="${"_blank"}" rel="${"noreferrer"}" class="${"link-underlined"}">submit a complaint. </a>  
  </p><h2>13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
...
<p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) , Patric Pförtner, by email at p.pfoertner@psychology4.me, or by post to:</p>

<p>Patric Pförtner</p>

<p>Ivan Pamukchiev 7A</p>
...
<p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please submit a request form by clicking 
  <a href="${"https://app.termly.io/notify/0250d804-c37f-43a2-89f5-1260643ae2a6"}" target="${"_blank"}" rel="${"noreferrer"}" class="${"link-underlined"}">here</a>. </p>
		
<h2>16. What&#39;s with Social Media?</h2>
<p>We maintain online presences within social networks and platforms in order to be able to communicate with the customers, interested parties and users active there and to inform them about our services. When accessing the respective networks and platforms, the terms and conditions and data processing guidelines of their respective operators apply.
  Unless otherwise stated in our data protection declaration, we process the data of users if they communicate with us within the social networks and platforms, e.g. write articles on our online presences or send us messages.</p>
<h2>17. Integration of third party services and content</h2>
<p>Within our online offer on the basis of our legitimate interests (i.e. interest in the analysis, optimisation and economic operation of our online offer in the sense of Art. 6 Par. 1 lit. f. GDPR), we use content or service offers from third parties in order to integrate their content and services, such as videos or fonts (hereinafter uniformly referred to as “content”).</p>
<p>This always presupposes that the third-party providers of these contents are aware of the IP address of the users, as without the IP address they would not be able to send the contents to their browsers. The IP address is therefore necessary for the display of this content. We make every effort to use only such content whose respective providers use the IP address only to deliver the content. Third party providers may also use so-called pixel tags (invisible graphics, also known as “web beacons”) for statistical or marketing purposes. “Pixel tags” can be used to evaluate information such as visitor traffic on the pages of this website. The pseudonymous information may also be stored in cookies on the user’s device and may contain technical information about the browser and operating system, referring websites, visiting time and other details about the use of our online offer, as well as being linked to such information from other sources.</p>
<h3>YouTube</h3>
<p>We integrate the videos of the “YouTube” platform of the provider Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. Privacy policy: https://www.google.com/policies/privacy/, Opt-Out: https://adssettings.google.com/authenticated.</p>

<h2>18. What Analytics &amp; Hosting do you use?</h2>
<p>Our website uses Plausible Analytics to help us understand visitor trends and the effectiveness of our marketing outreach. We chose Plausible Analytics because it is a privacy-focused company and platform that eschews personally identifiable information in favor of anonymous aggregate data. See the Plausible Analytics
  <a href="${"https://plausible.io/data-policy"}" target="${"_blank"}" class="${"link-underlined"}" rel="${"noreferrer"}">Data Policy.</a></p>
<p>We, or our hosting provider, on the basis of our legitimate interests as defined in Art. 6 Par. 1 lit. f. GDPR process data about every access to the server on which this service is located (so-called server log files). The access data includes the name of the accessed website, file, date and time of access, transferred data volume, notification of successful access, browser type and version, the user’s operating system, referrer URL (the previously visited site), IP address and the requesting provider.</p>
  <p>For security reasons (e.g. to clarify misuse or fraud), log file information is stored for a maximum of 7 days and then deleted. Data whose further storage is required for evidence purposes are excluded from deletion until the respective incident has been finally clarified.</p></div></div></div></section>`;
});
export {
  Page as default
};
